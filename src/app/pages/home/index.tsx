        ...
        >
            ...
            <main className='w-full flex flex-col gap-10 items-center max-w-5xl px-5 xl:max-w-7xl mt-[5.5rem]'>
                        ...
                        <div className='w-full flex flex-col z-[2] absolute left-0 bottom-0 leading-4 p-5 text-moonlit'>
                            ...
                            <div className='flex flex-wrap items-center gap-2 mt-1 lg:gap-3'>
                                <a
                                    ...
                                    href='https://github.com/franpfeiffer'
                                    target='_blank'
                                    rel='noreferrer'
                                    title='GitHub'
                                >
                ...
                <section className='w-full grid auto-rows-[380px] lg:auto-rows-[140px] grid-cols-8 gap-4'>
                    {Projects.slice(0, 4).map((project: IProjectCard) => {
                ...
                <div className='w-full flex justify-center'>
                    <a
                        href='/projects'
                        className='px-6 py-3 bg-white dark:bg-raisin-black rounded-xl text-sm font-medium hover:scale-105 transition-transform duration-300'
                    >
                        {t('projects-section.view-all')}
                    </a>
                </div>
                ...
                <section className='h-full w-full grid auto-rows-[260px] grid-cols-4 gap-4'>
